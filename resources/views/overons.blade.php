        ...
        <nav class="container mx-auto px-4 py-4">
            <div class="flex justify-between items-center">
                ...
                <div class="hidden md:flex space-x-8">
                    ...
                    <a href="/overons" class="text-alien-green font-semibold">Over Ons</a>
            ...
            <div id="mobile-menu" class="md:hidden hidden mt-4 space-y-2">
                ...
                <a href="/overons" class="block py-2 text-alien-green font-semibold">Over Ons</a>
                <a href="/contact" class="text-alien-green font-semibold">Contact</a>
            </div>
        </nav>
    </header>
